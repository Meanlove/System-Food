...
export default function App() {
  const products = {
    ...
    Food: [
      { id: 6, name: "ចាណាង", price: 3 },
      { id: 7, name: "សាច់ក្រក់", price: 3 },
      { id: 8, name: "ឡាបសាច់ជ្រូក", price: 3 },
      { id: 9, name: "ឆាក្ដៅសាច់គោ", price: 3 },
      { id: 10, name: "ឆាក្ដៅសាច់មាន់", price: 3 },
      { id: 11, name: "ឆាក្ដៅអន្ទង់", price: 3 },
    ],
  };
